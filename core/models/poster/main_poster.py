...
from github.BB.est_wassup_03.core.models.poster.tools.sam import SAM
...
def main():
    ...
    recorder = RecorderMeter(args.epochs) # 6개 
    recorder1 = RecorderMeter1(args.epochs) # 3개
    ...
    for epoch in range(args.start_epoch, args.start_epoch + args.epochs):
        ...
        recorder.update(epoch-281, train_los, train_acc, val_los, val_acc)
...
def validate(val_loader, model, criterion, args):
    ...
    with torch.no_grad():
        for i, (images, target) in enumerate(val_loader):
            ...
            C = confusion_matrix(y_ture, y_pred, labels=[0, 1, 2, 3, 4, 5, 6])
            D += C
    ...
    plot_confusion_matrix(D, labels, normalize=True)
...
class RecorderMeter(object):
    ...
    def update(self, idx, train_loss, train_acc, val_loss, val_acc):
        ...
        self.epoch_losses[idx, 1] = val_loss * 30 # IndexError: index 30 is out of bounds for axis 0 with size 30
